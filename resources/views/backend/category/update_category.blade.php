            ...
            <div class="row mt-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h4 class="header-title mb-2">Update Category</h4>
                            </div>

                            <form method="POST" action="{{ route('updating.category', $cateogry->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="category_name" value="{{ $cateogry->category_name }}"
                                                type="text" value="" class="form-control" id="firstname"
                ...
                <div class="col-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h4 class="header-title mb-2">Category List</h4>
